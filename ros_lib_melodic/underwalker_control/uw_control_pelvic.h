#ifndef _ROS_underwalker_control_uw_control_pelvic_h
#define _ROS_underwalker_control_uw_control_pelvic_h
...
namespace underwalker_control
{
  ...
  class uw_control_pelvic : public ros::Msg
  {
    public:
    ...
    virtual const char * getType() override { return "underwalker_control/uw_control_pelvic"; };
    virtual const char * getMD5() override { return "a09c710655fb850b97988a7c8b08f707"; };
