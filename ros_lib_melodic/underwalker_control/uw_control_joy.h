#ifndef _ROS_underwalker_control_uw_control_joy_h
#define _ROS_underwalker_control_uw_control_joy_h
...
namespace underwalker_control
{
  ...
  class uw_control_joy : public ros::Msg
  {
    public:
    ...
    virtual const char * getType() override { return "underwalker_control/uw_control_joy"; };
    virtual const char * getMD5() override { return "a2060a0f56164af5dedbe273ec768d14"; };
